...
public class LoggingAspect {
	...
	// 1) @Around 사용 시 반환형 무조건 Object
	// 2) @Around 메서드 종료 시 proceed 반환값을 return 해야 함
	...
	public Object aroundServiceImpl(ProceedingJoinPoint pjp) throws Throwable{
		...
		// 주요 자식 : Exception(예외), Error(오류)
		// Exception : 개발자가 처리할 수 있는 문제
		...
		// ------------------------------------------------------------
		Object obj = pjp.proceed();	// 전/후를 나누는 기점, Throwable 예외 처리해야 함
		// ------------------------------------------------------------
